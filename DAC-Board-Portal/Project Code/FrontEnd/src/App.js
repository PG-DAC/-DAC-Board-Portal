...
import rohini from "./pages/rohini.jpg";
import komal from "./pages/komal.jpg";
...
<header class="d-flex flex-column flex-md-row align-items-center h-200 p-3 px-md-4 mb-3  border-bottom shadow-sm stickytop" style={{backgroundColor:"darkslategray"}} >
 <a href="/"><p class="h5  me-md-auto  text-light"><img src={board} height="50" width="80" /></p></a> 
  ...
  <a class="btn btn-outline-warning me-md-2  " href="/signup">Register</a>
      ...
      <footer class="mastfoot mt-auto">
        <div class="inner">
          <p><b>All Rights Reserved By </b>  <a href="https://cdac.in/"> <b>@C-DAC Acts Team </b></a>.</p>
        </div>
      </footer>
      <br></br>
      <br></br>
...
function OurMoto(){//functional component
  return(
    <div>
      <div class="container" >
